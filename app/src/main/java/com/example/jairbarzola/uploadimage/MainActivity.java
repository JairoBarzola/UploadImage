package com.example.jairbarzola.uploadimage;
...
public class MainActivity extends AppCompatActivity
    ...
    private static final String UPLOAD_URL = "http://jairbarzola.esy.es/insert_image.php";
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == IMAGE_REQUEST_CODE && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            if(requestCode == 0) {
                ...
                saveImage(imageView);
                tvPath.setText(GetTheLastPhoto());
                filePath = Uri.parse(tvPath.getText().toString());

            }
        }
    }

    private String GetTheLastPhoto() {
        String imageLocation = "jeje";
    ...
    private void saveImage(ImageView imagen) {
    ...
    public void uploadMultipart() {
        ...
        try {
            ...
            new MultipartUploadRequest(this, uploadId, UPLOAD_URL)
                    .addFileToUpload(tvPath.getText().toString(),"image") //Adding file
